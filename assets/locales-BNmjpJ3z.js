const e = {
    ...
    q3: {
        ...
        title: "تعرِضُ نتائجُ البحثِ الخاصِّ بالعرض أو الفيلم اللذي أريد، لكن لماذا لا يمكنني تشغيله؟"
    },
    title: "حول movie-web"
},
a = {
...
t = {
    ...
    trust: {
        failed: {
            ...
            title: "تعَذَّر الوصول إلى الخادم"
        },
...
w = {
    ...
    titles: {
        day: {
            ...
            extra: ['Чувствате ли се авантюристично? "Джурасик Парк" може да бъде перфектният избор.']
        },
        morning: {
...
H = {
    ...
    titles: {
        day: {
            ...
            extra: ["Voleu aventura? Jurassic Park podria ser l'elecció perfecta."]
        },
        morning: {
...
ye = {
    ...
    titles: {
        day: {
            ...
            extra: ["Lust auf ein Abenteuer? Dann ist Jurassic Park genau das Richtige."]
        },
        morning: {
...
Ie = {
    ...
    titles: {
        day: {
            ...
            extra: ["Νιώθετε περιπετειώδης; Το Jurassic Park μπορεί να είναι η τέλεια επιλογή."]
        },
        morning: {
...
Ze = {
    ...
    titles: {
        day: {
            ...
            extra: ["¿Te sientes aventurero? Jurassic Park podría ser la elección perfecta."]
        },
        morning: {
...
ua = {
    ...
    titles: {
        day: {
            ...
            extra: ["Kas tunnete end seiklushimulisena? Jurassic Park võib olla ideaalne valik."]
        },
        morning: {
...
Sa = {
    ...
    titles: {
        day: {
            ...
            extra: ['به دنبال ماجراجویی هستید؟ "پارک ژوراسیک" انتخابی عالی است.']
        },
        morning: {
...
Ra = {
    ...
    titles: {
        day: {
            ...
            extra: ["Onko seikkailunhaluinen olo? Jurassic Park saattaa olla täydellinen valinta."]
        },
        morning: {
...
et = {
    ...
    titles: {
        day: {
            ...
            extra: ["Amoureux des films d'animation ? Suzume est un incontournable."]
        },
        morning: {
        ...
        night: {
            ...
            extra: ["À la recherche d'un bon film d'horreur à regarder ? J'ai entendu dire que Scream était bien."]
        }
    }
},
at = {
...
gt = {
    ...
    titles: {
        day: {
            ...
            extra: ["Sínteste aventureiro? Jurassic Park podería ser a elección perfecta."]
        },
        morning: {
...
Ct = {
    ...
    titles: {
        ...
        night: {
            ...
            extra: ["થાકી ગયા છો? મેં સાંભળ્યું છે કે The Exorcise ફિલ્મ સારી છે."]
        }
    }
},
Tt = {
...
ri = {
    ...
    titles: {
        day: {
            ...
            extra: ["साहसी महसूस कर रहे हैं? जुरासिक पार्क शायद सबसे उत्तम विकल्प हो सकता है।"]
        },
        morning: {
...
wi = {
    ...
    titles: {
        day: {
            ...
            extra: ["Lagi pengen nonton genre Adventure? Jurassic Park mungkin cocok buat anda."]
        },
        morning: {
...
Ii = {
    ...
    titles: {
        day: {
            ...
            extra: ["Fynnst þér þú vera ævintýralegur? Jurrasic Park gæti verið fullkomna valið."]
        },
        morning: {
...
Ji = {
    ...
    titles: {
        day: {
            ...
            extra: ["Senti avventuroso? Jurassic Park potrebbe essere la scelta perfetta."]
        },
        morning: {
...
zo = {
    ...
    titles: {
        day: {
            ...
            extra: ["모험을 즐기고 싶으신가요? 쥬라기 공원이 완벽한 선택이 될 수 있습니다."]
        },
        morning: {
...
Yo = {
    ...
    titles: {
        day: {
            ...
            extra: ["Feeling banana? Jurassic banana banana banana banana perfect banana."]
        },
        morning: {
            default: "What would you like to banana this banana?",
...
pn = {
    ...
    titles: {
        day: {
            ...
            extra: ["साहसिक महसुस गर्दै हुनुहुन्छ? जुरासिक पार्क उत्तम विकल्प हुन सक्छ।"]
        },
        morning: {
...
Dn = {
    ...
    titles: {
        day: {
            ...
            extra: ["Voel je je avontuurlijk? Dan is Jurassic Park misschien wel de perfecte keuze."]
        },
        morning: {
...
Wn = {
    ...
    titles: {
        day: {
            ...
            extra: ["ਸਾਹਸੀ ਮਹਿਸੂਸ ਕਰ ਰਹੇ ਹੋ? ਜੁਰਾਸਿਕ ਪਾਰਕ ਸੰਪੂਰਣ ਵਿਕਲਪ ਹੋ ਸਕਦਾ ਹੈ."]
        },
        morning: {
...
nr = {
    ...
    titles: {
        day: {
            ...
            extra: ["Feelin' adventurous? Pirates of the Caribbean might be the perfect choice."]
        },
        morning: {
            default: "What be yer fancy for this mornin's viewing, me heartie?",
            extra: ["I be hearin' that 'Before Sunrise' be a fine choice, me heartie"]
        },
        night: {
            default: "What be yer desire for the night's entertainment, me heartie?",
            extra: ["Feelin' weary, are ye? I be hearin' 'The Exorcist' be a good pick to stir the spirits, me heartie."]
        }
    }
},
rr = {
...
yr = {
    ...
    titles: {
        day: {
            ...
            extra: ["Masz ochotę na przygodę? Park Jurajski może być idealnym wyborem."]
        },
        morning: {
...
Ir = {
    ...
    titles: {
        day: {
            ...
            extra: ["Se sentindo aventureiro? Jurassic Park pode ser a escolha perfeita."]
        },
        morning: {
...
Jr = {
    ...
    titles: {
        day: {
            ...
            extra: ["Sentindo-se aventureiro? Jurassic Park pode ser a escolha perfeita."]
        },
        morning: {
...
us = {
    ...
    titles: {
        day: {
            ...
            extra: ["Te simți aventuros? Jurassic Park ar putea fi o alegere perfectă."]
        },
        morning: {
...
js = {
    ...
    titles: {
        day: {
            ...
            extra: ["Любите приключения? «Парк Юрского периода» прекрасно подойдет вам."]
        },
        morning: {
        ...
        night: {
            ...
            extra: ['Тяжелый день? Можем посоветовать вам фильм "Изгоняющий дьявола".']
        }
    }
},
Ss = {
...
Fs = {
    ...
    titles: {
        day: {
            ...
            extra: ["Se počutite pustolovsko? Jurski park je morda odlična izbira."]
        },
        morning: {
        ...
        night: {
            ...
            extra: ['Utrujeni? Slišal sem, da je "Izganjalec mrtvih" odličen film.']
        }
    }
},
Rs = {
...
Zl = {
    ...
    titles: {
        day: {
            ...
            extra: ["Maceraperest mi hissediyorsun? Jurassic Park iyi bir seçim olabilir."]
        },
        morning: {
...
dd = {
    ...
    titles: {
        day: {
            ...
            extra: ["Хочете пригод? Парк Юрського періоду може стати ідеальним вибором."]
        },
        morning: {
...
export {
lu as A, mu as B, gu as C, fu as D, xu as E, Su as F, Lu as G, Fu as H, Vu as I, Gu as J, zu as K, $u as L, ku as M, Eu as N, Mu as O, hu as P, Tu as Q, uu as a, Nu as b, du as c, cu as d, Uu as e, vu as f, Pu as g, yu as h, ju as i, ru as j, pu as k, Au as l, Du as m, Cu as n, bu as o, Bu as p, Ou as q, wu as r, Ru as s, Wu as t, Iu as u, Ku as v, qu as w, Hu as x, su as y, Qu as z
};
//# sourceMappingURL=locales-BNmjpJ3z.js.map